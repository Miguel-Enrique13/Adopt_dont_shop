...
describe 'pets index page', type: :feature do
  it 'can show the img, name, age, sex, and shelter for each pet' do
    ...
    pet1 = Pet.create!(image: '/app/assets/images/img001.jpg', name: 'Olaf', age: 3, sex: 'Male', shelter: shelter1)
    pet2 = Pet.create!(image: '/app/assets/images/img002.jpg',name: 'Kitty', age: 7, sex: 'Female', shelter: shelter2)
